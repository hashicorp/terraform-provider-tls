		...
		Steps: []r.TestStep{
			{
				...
				Check: r.ComposeAggregateTestCheckFunc(
					...
					tu.TestCheckPEMCertificateRequestSignatureAlgorithm("tls_cert_request.test1", "cert_request_pem", x509.PureEd25519),
				),
			},
			{
				Config: `
...
func TestResourceCertRequest_SignatureAlgorithmPss(t *testing.T) {
	r.UnitTest(t, r.TestCase{
		ProtoV5ProviderFactories: protoV5ProviderFactories(),
		Steps: []r.TestStep{
			{
				...
				Check: r.ComposeAggregateTestCheckFunc(
					...
					tu.TestCheckPEMCertificateRequestSignatureAlgorithm("tls_cert_request.test1", "cert_request_pem", x509.SHA256WithRSAPSS),
				),
			},
		},
	})
