...
- `name_constraint_permitted_dns_names` (List of String) List of permitted DNS names for which a certificate name constraints is being requested (i.e. permitted DNS domains).
