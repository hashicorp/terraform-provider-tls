...
- `allowed_uses` (List of String) List of key usages allowed for the issued certificate. Values are defined in [RFC 5280](https://datatracker.ietf.org/doc/html/rfc5280) and combine flags defined by both [Key Usages](https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.1.3) and [Extended Key Usages](https://datatracker.ietf.org/doc/html/rfc5280#section-4.2.1.12). Accepted values: `key_agreement`, `crl_signing`, `encipher_only`, `digital_signature`, `content_commitment`, `data_encipherment`, `key_encipherment`, `cert_signing`, `decipher_only`, `any_extended`, `server_auth`, `client_auth`, `timestamping`, `microsoft_kernel_code_signing`, `ipsec_tunnel`, `ipsec_user`, `netscape_server_gated_crypto`, `email_protection`, `ipsec_end_system`, `code_signing`, `ocsp_signing`, `microsoft_server_gated_crypto`, `microsoft_commercial_code_signing`.
- `ca_cert_pem` (String) Certificate data of the Certificate Authority (CA)
